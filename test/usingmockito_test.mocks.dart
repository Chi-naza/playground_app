...
// in playground_app/test/usingmockito_test.dart.
...
import 'package:get/get_connect/http/src/certificates/certificates.dart' as _i8;
...
class _FakeGraphQLResponse_5<T1> extends _i1.SmartFake
    implements _i4.GraphQLResponse<T1> {
...
class MockGetConnect extends _i1.Mock implements _i6.GetConnect {
  ...
  @override
  set trustedCertificates(List<_i8.TrustedCertificate>? _trustedCertificates) =>
      super.noSuchMethod(
  ...
  @override
  _i9.Future<_i4.Response<T>> get<T>(
    String? url, {
    ...
    _i2.Decoder<T>? decoder,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i9.Future<_i4.Response<T>>.value(
              _FakeResponse_3<T>(
                this,
                Invocation.method(
                  #get,
          ...
          as _i9.Future<_i4.Response<T>>);

  @override
  _i9.Future<_i4.Response<T>> post<T>(
    String? url,
    dynamic body, {
    String? contentType,
    Map<String, String>? headers,
  ...
  @override
  _i9.Future<_i4.Response<T>> put<T>(
    String? url,
    dynamic body, {
    String? contentType,
    Map<String, String>? headers,
  ...
  @override
  _i9.Future<_i4.Response<T>> patch<T>(
    String? url,
    dynamic body, {
    String? contentType,
    Map<String, String>? headers,
  ...
  @override
  _i9.Future<_i4.Response<T>> request<T>(
    String? url,
    String? method, {
    dynamic body,
    String? contentType,
  ...
  @override
  _i9.Future<_i4.Response<T>> delete<T>(
    String? url, {
    Map<String, String>? headers,
    String? contentType,
    Map<String, dynamic>? query,
  ...
  @override
  _i9.Future<_i4.GraphQLResponse<T>> query<T>(
    String? query, {
    String? url,
    ...
    Map<String, String>? headers,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i9.Future<_i4.GraphQLResponse<T>>.value(
          ...
          as _i9.Future<_i4.GraphQLResponse<T>>);

  @override
  _i9.Future<_i4.GraphQLResponse<T>> mutation<T>(
    String? mutation, {
    String? url,
    Map<String, dynamic>? variables,
    Map<String, String>? headers,
